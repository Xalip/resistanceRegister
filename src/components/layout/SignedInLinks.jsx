...
function SignedInLinks(props) {
    return (
        <Fragment>
            <li className="nav-item"><NavLink className="nav-link" to="/test/upload">Upload</NavLink></li>
            <li className="nav-item"><NavLink className="nav-link" to="/personalData">PersonalData
            </NavLink></li>
