...
class TestUpload extends Component {
          ...
          <form onSubmit={this.handleSubmit}>
            <div className="form-group">
              <div className="custom-file">
                ...
                />
                <label className="custom-file-label" htmlFor="resultImage">
                  Datei auswählen...
                </label>
              </div>
            ...
            <div className="form-group">
              <label className="form-label" htmlFor="resultSelect">
                Ergebnis auswählen
              </label>
              <select
  ...
  isSaveEnabled() {
    return (
      this.state.result && this.state.result !== "NONE" && this.state.image
    );
  }
}
